...
import AnswersQuestion from '../components/tezt/AnswersQuestion';
...
const Grades = () => {
    ...
    const submit = async () => {
        if (correct.includes(undefined)) {
            ...
            navigate('/admin-user-analytics', { state: data });
        }
    };
    useEffect(() => {
        ...
        <>
                    ...
                    <Container>
                        <div className="studydivform">
                            <div className="study-block">
                                ...
                                <h1 className="text-white text-center my-4">Tezt Answer</h1>
            ...
            <div className="questionsection">
                <Container>
                    <Row>
                        <Col sm={12}>
                            <AnswersQuestion setScore={setScore} correct={correct} setCorrect={setCorrect} />
                        </Col>
                    </Row>
                </Container>
            </div>
                    ...
                    <Row>
                        ...
                        <Col xs={12} md={6} className="text-end createbtn">
                            <div className="gradient-border me-3">
                                <Button onClick={submit}>continue to user analytics</Button>
                            </div>
                        </Col>
                    </Row>
                </Container>
